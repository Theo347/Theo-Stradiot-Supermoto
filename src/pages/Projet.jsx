      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div data-aos="fade-up">
            <h2 className="text-2xl sm:text-3xl font-bold uppercase mb-6">Ma <span className="!text-[#FF0000]">Présentation</span></h2>
            <div className="text-gray-100 font-semibold space-y-4 text-sm sm:text-base">
              ...
              <ul className="space-y-2 font-bold">
                <li className="flex items-center gap-2 text-white"><span className="!text-[#FF0000]">▸</span> Le dépassement de soi</li>
                <li className="flex items-center gap-2 text-white"><span className="!text-[#FF0000]">▸</span> La progression constante</li>
                <li className="flex items-center gap-2 text-white"><span className="!text-[#FF0000]">▸</span> La rigueur de l’entraînement</li>
              </ul>
            </div>
          </div>

          <div data-aos="fade-up" data-aos-delay="200">
            <h2 className="text-2xl sm:text-3xl font-bold uppercase mb-6">Les 3 axes du <span className="!text-[#FF0000]">Projet</span></h2>
            <div className="space-y-6">
              ...
              <div className="bg-[#111111] p-5 sm:p-6 rounded-lg border-l-4 border-[#CC0000] shadow-md" data-aos="fade-left" data-aos-delay="400">
                <h4 className="text-lg sm:text-xl font-bold text-white mb-2">2️⃣ Entraînement technique</h4>
              ...
              <div className="bg-[#111111] p-5 sm:p-6 rounded-lg border-l-4 border-[#CC0000] shadow-md" data-aos="fade-left" data-aos-delay="500">
                <h4 className="text-lg sm:text-xl font-bold text-white mb-2">3️⃣ Objectif compétition</h4>
