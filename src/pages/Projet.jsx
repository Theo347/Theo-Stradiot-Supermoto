      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div data-aos="fade-up">
            <h2 className="text-2xl sm:text-3xl font-bold uppercase mb-6">Ma <span className="text-[#CC0000]">Présentation</span></h2>
          ...
          <div data-aos="fade-up" data-aos-delay="200">
            <h2 className="text-2xl sm:text-3xl font-bold uppercase mb-6">Les 3 axes du <span className="text-[#CC0000]">Projet</span></h2>
