...
export default function Home() {
  return (
    <section className="pt-28 md:pt-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col md:flex-row items-center min-h-[80vh]">
      ...
      <div className="w-full md:w-1/2 mt-10 md:mt-0 relative flex justify-center" data-aos="fade-left" data-aos-delay="300">
        <div className="w-full max-w-xs sm:max-w-md aspect-square bg-gradient-to-tr from-[#CC0000]/20 to-black rounded-3xl flex items-center justify-center border border-[#CC0000]/30 shadow-[0_0_40px_rgba(204,0,0,0.2)] overflow-hidden">
           <img src="/TheoPPMoto.png" alt="Théo Stradiot Supermoto" className="w-full h-full object-cover" />
        </div>
      </div>
    </section>
  );
