...
function App() {
  useEffect(() => {
    AOS.init({
      ...
      once: true, // L'animation ne s'exécute qu'une seule fois en descendant
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-black p-8 md:p-12 rounded-2xl border border-[#CC0000]/20 shadow-2xl" data-aos="zoom-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {/* Discord */}
              <a href="https://discord.gg/sa6bTmz7H4" target="_blank" rel="noreferrer" className="flex items-center gap-4 p-4 bg-[#111111] rounded-xl border border-gray-800 hover:border-[#CC0000] transition-all group" data-aos="fade-up" data-aos-delay="400">
                <div className="w-12 h-12 bg-[#CC0000]/10 text-[#CC0000] rounded-full flex items-center justify-center group-hover:bg-[#CC0000] group-hover:text-white transition-colors">
